// Vendored from neo-git-graph (https://github.com/asispts/neo-git-graph),
// an MIT-licensed fork of vscode-git-graph. SVG commit-graph layout + renderer.
//
//   Copyright (c) 2019 mhutchie. Fork (c) 2026-present asispts. MIT License.
//
// Local modifications: types moved from the extension's ambient globals to
// ./types, and the constructor takes a container element rather than a DOM id.

import type { Config, ExpandedCommit, GitCommitNode, Line, PlacedLine, Point } from './types'
